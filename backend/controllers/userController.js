...
//Api to book appoinments

const bookAppoinments = async(req,res) => {
 try {
  ...
  if(slots_booked[slotDate]){
   ...
   const newAppoinment = new appoinmentData(appoinmentData)
...
export {registerUser,loginUser,getProfile,updateProfile,bookAppoinments}